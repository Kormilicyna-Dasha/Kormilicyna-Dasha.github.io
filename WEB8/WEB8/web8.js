document.addEventListener('DOMContentLoaded', () => {
    ...
    feedbackForm.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('https://formcarry.com/s/_zyy2Llap8Z', {
                method: 'POST',
                headers: {
...
.then(data => {
    ...
    document.getElementById('feedbackForm').reset(); // Сбросить форму

    // Перенаправление на страницу "Спасибо"
    setTimeout(() => {
        window.location.href = 'https://ваш-сайт.com/спасибо'; // Замените на нужный URL
